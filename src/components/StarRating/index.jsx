...
function StarRating({ ratingStarNumber, countRatingPeople }) {
  ...
  return (
    <div className="flex items-center justify-center">
      ...
      <span className="ml-4 text-gray-300">{countRatingPeople}</span>
    </div>
  )
}
