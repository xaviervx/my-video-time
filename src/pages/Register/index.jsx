        ...
        <form>
          <div className="w-full justify-between gap-10 flex flex-row">
            <div>
              ...
              />
              <ErrorMessage errorText={ errors?.name?.message } color="text-red-600" />
              <Controller
                name="email"
                control={ control }
                render={ ({ field }) => (
              ...
              />
              <ErrorMessage errorText={ errors.email?.message } color="text-red-600" />
              <Controller
                name="phone"
                control={ control }
                as={ InputMask }
              ...
              />
              <ErrorMessage errorText={ errors.phone?.message } color="text-red-600" />
              <Controller
                name="gender"
                control={ control }
                rules={ { required: true } }
              ...
              />
              <ErrorMessage errorText={ errors.gender?.message } color="text-red-600" />
              <Controller
                name="city"
                control={ control }
                render={ ({ field }) => (
              ...
              />
              <ErrorMessage errorText={ errors.city?.message } color="text-red-600" />
              <Controller
                name="password"
                control={ control }
                render={ ({ field }) => (
              ...
              />
              <ErrorMessage errorText={ errors.retypedPassword?.message } color="text-red-600" />
            </div>
            <div>
              ...
              />
              <ErrorMessage errorText={ errors?.cep?.message } color="text-red-600" />
              <Controller
                name="state"
                control={ control }
                render={ ({ field }) => (
              ...
              />
              <ErrorMessage errorText={ errors.state?.message } color="text-red-600" />
              <Controller
